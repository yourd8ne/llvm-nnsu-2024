...
class X86VyunovInstCounter : public MachineFunctionPass {
public:
  static char ID;
  X86VyunovInstCounter() : MachineFunctionPass(ID) {}
  bool runOnMachineFunction(llvm::MachineFunction &MF) override;
};
} // namespace

char X86VyunovInstCounter::ID = 0;

bool X86VyunovInstCounter::runOnMachineFunction(llvm::MachineFunction &MF) {
...
static RegisterPass<X86VyunovInstCounter>
    X("x86-vyunov-inst-cnt", "Instruction counter", false, false);