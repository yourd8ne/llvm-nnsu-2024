...
namespace {
class X86KazantsevPass : public MachineFunctionPass {
public:
  static char ID;

  X86KazantsevPass() : MachineFunctionPass(ID) {}

  bool runOnMachineFunction(MachineFunction &MF) override;

  StringRef getPassName() const override { return "X86 Kazantsev Pass"; }
};
} // namespace

char X86KazantsevPass::ID = 0;

bool X86KazantsevPass::runOnMachineFunction(MachineFunction &MF) {
  bool Modified = false;
